    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            SELECT 
                ...
                ROUND(o.calculation_additional_transport_costs_total / NULLIF(o.calculation_quantityA, 0), 2)
                ...
                ROUND(((o.calculation_additional_box_count * o.calculation_additional_box_price_per_piece) + 
                      o.calculation_additional_box_price_flat_additional) / NULLIF(o.calculation_quantityA, 0), 2)
                ...
                ROUND((o.calculation_working_setup_quantity * o.calculation_quantityA / 100) / 
                      NULLIF(o.calculation_working_extrusion_speed, 0), 2)
                    AS _calculation_working_setup_time,

                ROUND(o.calculation_working_tool_costs_customer / NULLIF(o.calculation_working_tool_costs_total, 0) * 100, 2)
                ...
                ROUND(
                    (o.calculation_working_allocation_costs_additional +
                     ...
                     NULLIF((o.calculation_working_annual_requirement_estimated * o.calculation_working_tool_costs_amortization_years), 0),
                    2
