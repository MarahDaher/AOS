...
class CreateOffersCalculatedView extends Migration
{
  public function up(): void
  {
    DB::statement(
      ...
      --  Summe
          -1 AS `_pricing_endprices_calc_sum`,

      --  Staffel / m
          -1 AS `_pricing_endprices_graduated_without_confection_lfm_quantityA`,
          -1 AS `_pricing_endprices_graduated_without_confection_lfm_quantityB`,
          -1 AS `_pricing_endprices_graduated_without_confection_lfm_quantityC`,
          -1 AS `_pricing_endprices_graduated_without_confection_lfm_quantityD`,
          -1 AS `_pricing_endprices_graduated_without_confection_lfm_quantityE`,

      --  Staffel / stk
          -1 AS `_pricing_endprices_graduated_without_confection_stk_quantityA`,
          -1 AS `_pricing_endprices_graduated_without_confection_stk_quantityB`,
          -1 AS `_pricing_endprices_graduated_without_confection_stk_quantityC`,
          -1 AS `_pricing_endprices_graduated_without_confection_stk_quantityD`,
          -1 AS `_pricing_endprices_graduated_without_confection_stk_quantityE`,

      --  Stück
          -1 AS `_pricing_endprices_graduated_pieces_quantityA`,
          -1 AS `_pricing_endprices_graduated_pieces_quantityB`,
          -1 AS `_pricing_endprices_graduated_pieces_quantityC`,
          -1 AS `_pricing_endprices_graduated_pieces_quantityD`,
          -1 AS `_pricing_endprices_graduated_pieces_quantityE`,
      ...
      --  Staffelpreise Produktionszeit -- graduated prices productiontime
          -1 AS `_pricing_graduated_calculation_productiontime_quantityA`, 
          -1 AS `_pricing_graduated_calculation_productiontime_quantityB`, 
          -1 AS `_pricing_graduated_calculation_productiontime_quantityC`, 
          -1 AS `_pricing_graduated_calculation_productiontime_quantityD`, 
          -1 AS `_pricing_graduated_calculation_productiontime_quantityE`,
      ...
      --    (_calculation_working_profile_weight_average / 1000 * _pricing_graduated_calculation_quantityA*calculation_working_setup_quantity_relative/100) 
          ...
          -1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityA`, 
          -1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityB`, 
          -1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityC`, 
          -1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityD`, 
          -1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityE`,

      --  Staffelpreise Zwischensummen -- graduated prices subtotals
          -1 AS `_pricing_graduated_calculation_subtotal_quantityA`, 
          -1 AS `_pricing_graduated_calculation_subtotal_quantityB`, 
          -1 AS `_pricing_graduated_calculation_subtotal_quantityC`, 
          -1 AS `_pricing_graduated_calculation_subtotal_quantityD`, 
          -1 AS `_pricing_graduated_calculation_subtotal_quantityE`,

      --  Staffelpreise Zwischensummen / m -- graduated prices subtotals lfm
          -1 AS `_pricing_graduated_calculation_subtotal_lfm_quantityA`, 
          -1 AS `_pricing_graduated_calculation_subtotal_lfm_quantityB`, 
          -1 AS `_pricing_graduated_calculation_subtotal_lfm_quantityC`, 
          -1 AS `_pricing_graduated_calculation_subtotal_lfm_quantityD`, 
          -1 AS `_pricing_graduated_calculation_subtotal_lfm_quantityE`,

      -- Maschinenauslastung->Stunden -- machine utilization->hours
          -1 AS `_pricing_machine_utilization_hours_quantity_yearly`, 
          -1 AS `_pricing_machine_utilization_hours_quantityA`, 
          -1 AS `_pricing_machine_utilization_hours_quantityB`, 
          -1 AS `_pricing_machine_utilization_hours_quantityC`, 
          -1 AS `_pricing_machine_utilization_hours_quantityD`, 
          -1 AS `_pricing_machine_utilization_hours_quantityE`,

      -- Maschinenauslastung->Tage -- machine utilization->days
          -1 AS `_pricing_machine_utilization_days_quantity_yearly`, 
          -1 AS `_pricing_machine_utilization_days_quantityA`, 
          -1 AS `_pricing_machine_utilization_days_quantityB`, 
          -1 AS `_pricing_machine_utilization_days_quantityC`, 
          -1 AS `_pricing_machine_utilization_days_quantityD`, 
          -1 AS `_pricing_machine_utilization_days_quantityE`,
...
--  Staffelpreise Produktionszeit -- graduated prices productiontime
    -1 AS `_pricing_graduated_calculation_productiontime_quantityA`,
    -2 AS `_pricing_graduated_calculation_productiontime_quantityB`,
    -3 AS `_pricing_graduated_calculation_productiontime_quantityC`,
    -4 AS `_pricing_graduated_calculation_productiontime_quantityD`,
    -5 AS `_pricing_graduated_calculation_productiontime_quantityE`,
...
--    (_calculation_working_profile_weight_average / 1000 * _pricing_graduated_calculation_quantityA*calculation_working_setup_quantity_relative/100)
    ...
    1 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityA`,
    2 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityB`,
    3 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityC`,
    4 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityD`,
    5 AS `_pricing_graduated_calculation_rawmaterialquantity_quantityE`,


--  Staffelpreise Zwischensummen -- graduated prices subtotals
    6 AS `_pricing_graduated_calculation_subtotal_quantityA`,
    7 AS `_pricing_graduated_calculation_subtotal_quantityB`,
    8 AS `_pricing_graduated_calculation_subtotal_quantityC`,
    9 AS `_pricing_graduated_calculation_subtotal_quantityD`,
    10 AS `_pricing_graduated_calculation_subtotal_quantityE`,


--  Staffelpreise Zwischensummen / m -- graduated prices subtotals lfm
    11 AS `_pricing_graduated_calculation_subtotal_lfm_quantityA`,
    12 AS `_pricing_graduated_calculation_subtotal_lfm_quantityB`,
    13 AS `_pricing_graduated_calculation_subtotal_lfm_quantityC`,
    14 AS `_pricing_graduated_calculation_subtotal_lfm_quantityD`,
    15 AS `_pricing_graduated_calculation_subtotal_lfm_quantityE`,
...
-- Stück-Längen-Preise Länge 1333mm -- piece-length-prices length 1333mm    
    ...
    -1 AS `_pricing_piece_length_prices_length1333_quantityC`,
    -1 AS `_pricing_piece_length_prices_length1333_quantityD`,
    o_c._pricing_piece_length_prices_length1333_quantityE
