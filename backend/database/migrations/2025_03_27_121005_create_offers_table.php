...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('offers', function (Blueprint $table) {
            ...
            $table->unsignedInteger('general_packaging')->nullable();
            ...
            $table->unsignedInteger('general_request_number')->nullable();
            ...
            $table->unsignedInteger('calculation_processing_lfm_runtime_factor')->nullable();
            $table->unsignedInteger('calculation_processing_piece_runtime_factor')->nullable();
            ...
            $table->unsignedInteger('calculation_processing_lfm_packing_time_factor')->nullable();
            $table->unsignedInteger('calculation_processing_piece_packing_time_factor')->nullable();
            $table->unsignedInteger('calculation_additional_setup_time')->nullable();
            $table->float('calculation_additional_hourly_rate')->nullable();
            $table->float('calculation_additional_transport_costs_total')->nullable();
            $table->unsignedInteger('calculation_additional_box_count')->nullable();
            ...
            $table->unsignedInteger('calculation_working_setup_quantity_relative')->nullable();
            $table->float('calculation_working_extrusion_speed')->nullable();
            $table->unsignedInteger('calculation_working_annual_requirement_estimated')->nullable();
            $table->float('calculation_working_tool_costs_total')->nullable();
            $table->float('calculation_working_tool_costs_customer')->nullable();
            $table->unsignedInteger('calculation_working_tool_costs_amortization_years')->nullable();
            $table->unsignedInteger('calculation_working_allocation_costs_additional')->nullable();
            ...
            $table->unsignedInteger('calculation_working_setup_quantity_total')->nullable();
            $table->unsignedInteger('calculation_working_hourly_rate')->nullable();
            ...
            $table->unsignedInteger('pricing_annual_requirement')->default(0);
            $table->unsignedInteger('pricing_graduated_calculation_additional_setup_quantity')->default(0);
            $table->float('pricing_costs_calc_price_additional_lfm')->nullable();

            $table->unsignedInteger('pricing_grad_qtyB_add_hourlyrate')->nullable();
            $table->unsignedInteger('pricing_grad_qtyC_add_hourlyrate')->nullable();
            $table->unsignedInteger('pricing_grad_qtyD_add_hourlyrate')->nullable();
            $table->unsignedInteger('pricing_grad_qtyE_add_hourlyrate')->nullable();
            ...
            $table->unsignedInteger('pricing_machine_utilization_annual_machine_capacity')->nullable();

            $table->unsignedInteger('runningcard_extrusion_speed_IST')->nullable();
            $table->unsignedInteger('runningcard_profile_weight_IST')->nullable();
            $table->date('runningcard_sampling_date')->nullable();
            $table->unsignedInteger('runningcard_sampling_quantity')->nullable();
            $table->unsignedInteger('runningcard_sampling_length')->nullable();
            $table->unsignedInteger('runningcard_sampling_packing')->nullable();
            ...
            $table->unsignedInteger('runningcard_packing_length')->nullable();
            $table->unsignedInteger('runningcard_packing_packing_unit')->nullable();
            $table->unsignedInteger('runningcard_packing_quantity')->nullable();
            $table->text('runningcard_packing_description')->nullable();
            $table->unsignedInteger('runningcard_hourlyrecording_construction')->nullable();
            $table->unsignedInteger('runningcard_hourlyrecording_toolwork')->nullable();
            $table->unsignedInteger('runningcard_hourlyrecording_entry')->nullable();
            $table->unsignedInteger('runningcard_hourlyrecording_entrystitches')->nullable();

            $table->foreignId('runningcard_hourlyrecording_entrydriver_user_id')->nullable()->constrained('users')->restrictOnDelete()->restrictOnUpdate();
            $table->foreignId('runningcard_hourlyrecording_toolmaker_user_id')->nullable()->constrained('users')->restrictOnDelete()->restrictOnUpdate();
